...
### Genotyping
The genotyping protocol is the same as the the [B6.VH125+/+ protocol](/mouses/mouse-strains#b-6-vh-125) above.
# NOD.Vk125+/+
...
### Genotyping
The genotyping protocol is the same as the the [B6.Vk125+/+ protocol](/mouses/mouse-strains#b-6-vk-125) above.
# NOD.VH+/+Vk+/+
These mice have both the V<sub>H</sub>125 gene and the V<sub>k</sub>125 gene inserted into both copies of the genome, on a NOD background.
...
### Genotyping
The genotyping protocols of both the [B6.VH125+/+ mouse](/mouses/mouse-strains#b-6-vh-125) and the [B6.Vk125+/+ mouse](/mouses/mouse-strains#b-6-vk-125) must be used to determine the genotype of this mouse.
# SAP-/- IL15-/-
